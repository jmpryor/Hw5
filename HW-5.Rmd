...
Yes my confidence interval captures the true average size.
```{r}
mean(population)
```
...
1 confidence interval doesn't contain the true population mean
...
8 intervals do not contain the true population mean.
# Question 8
